...
class ArchivoConfigServicio:
    ...
    def agregar_archivo_inicial(self, ruta_archivo):
        try:
            ...
            if xml_file.readable():
                ...
                for empresa in xml_data.findall("empresa"):
                    ...
                    nueva_empresa = Empresa(self.contador,identificacion_empresa, nombre_empresa, abreviatura_empresa, lista_puntos_atencion)
    ...
    def aumentar_prueba(self, ruta_archivo):
        try:
            xml_file = open(ruta_archivo, encoding="utf-8")
            if xml_file.readable():
                xml_data = ET.fromstring(xml_file.read())
